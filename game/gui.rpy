...
define gui.accent_color = u'#260000'
define gui.label_color = u'#000000'

## 텍스트 버튼(text button)이 선택(selected)됐거나 커서를 올리지(hovered) 않았을
## 때 사용됩니다.
define gui.idle_color = u'#614532'

## 작은(small) 색상은 같은 효과를 내기 위해 더 밝거나 어두워야 하는 작은 글자에
## 사용됩니다.
define gui.idle_small_color = u'#222222'
...
## 됩니다.
define gui.selected_color = u'#5e0100'
...
## 인-게임 글자에 사용됩니다.
define gui.text_font = "경기천년제목_Medium.ttf"

## 캐릭터의 이름에 사용됩니다.
define gui.name_text_font = "경기천년제목_Medium.ttf"

## 인터페이스에 사용됩니다.
define gui.interface_text_font = "경기천년제목_Medium.ttf"
...
# define gui.main_menu_background = Movie(play="video/Title.avi", loop = False, size=(1920,1080))
define gui.main_menu_background_avi = Movie(size = (1920, 1080), channel = "movie", play = "video/Title.avi", loop = False)
define gui.main_menu_background_png = "gui/main_menu.png"
...
define gui.textbox_height = 278 # 278
...
define gui.choice_button_text_yalign = 0.1
...
define gui.navigation_xpos = 208
define gui.navigation_xpos_1 = 50
# define gui.navigation_ypos = 350
define gui.navigation_ypos = 410
...
# define gui.confirm_frame_borders = Borders(190, 150, 190, 70)
